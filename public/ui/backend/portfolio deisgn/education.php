                    ...
                    <form class="mt-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select" aria-label="Default select example">
                                ...
                                <option value="2">MSC/Equivalent</option>
                                <option value="2">BSC in Engineering/Equivalent</option>
                                <option value="2">HSC/Equivalent</option>
                                <option value="2">SSC/Equivalent</option>
                            </select>
                        </div>
                        <div class="row mb-3">
                            <div class="col">
                        ...
                        <div>
                            ...
                            <input type="text" class="form-control" name="scuname" id="scuname" required>
                        </div>
