...
<body>
    ...
    <main class="container" style="width: 800px;">
        <div class="mt-5">
            <ul>
                <li><a class="btn btn-secondary btn-sm">Print Profile</a></li>
                <li><a class="btn btn-secondary btn-sm">Download Profile as PDF</a></li>
                <li><a class="btn btn-secondary btn-sm">Download Profile as Excel</a></li>
            </ul>
        </div>
