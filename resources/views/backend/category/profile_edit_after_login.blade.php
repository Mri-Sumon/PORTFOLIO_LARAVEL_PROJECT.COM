<x-backend.layouts.master>
    ...
    <div class="row my-5">
        ...
        <div class="col-lg-2 col-md-6 col-sm-12 mb-2">
            <a href="{{route('category.profile_view_after_login')}}" type="button" class="btn btn-secondary bg-gradient btn-sm" style="width: 100%;">Profile View</a>
        </div>
    </div>
    ...
    <div class="accordion accordion-flush" id="accordionFlushExample">
        ...
        <div class="accordion-item">
            ...
            <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                ...
                {{-- FORM DATA SUBMIT START HERE --}}
                    <form class="mb-5" action="{{url('updateProfileAfterLogin/'.$authorizedUser->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('patch')
                        <label for="contact_number" class="form-label mb-3">Contuct Number</label>
                        <input type="tel" name="contact_number" id="contact_number" value="{{$authorizedUser->contact_number ?? ''}}" class="form-control mb-3" required>

                        <label for="address" class="form-label mb-3">Present Address</label>
                        <input type="text" name="address" id="address" value="{{$authorizedUser->address ?? ''}}" class="form-control mb-3" required>
                        ...
                        <select name="occupation" id="" class="form-select mb-3" aria-label="Default select example" required>
                            <option value="{{$authorizedUser->occupation ?? ''}}">{{$authorizedUser->occupation ?? ''}}</option>
                        ...
                        <select name="job_status" class="form-select mb-3" aria-label="Default select example" required>
                            <option value="{{$authorizedUser->job_status ?? ''}}">{{$authorizedUser->job_status ?? ''}}</option>
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col">
                                <input type="text" value="{{$authorizedUser->cv_uploaded ?? ''}}" class="form-control mb-3">
                            </div>
                        </div>
                    ...
                    <div class="mx-4 my-5">
                        @foreach ($aboutData as $Data)
                            @if($authorizedUser->id == $Data->id)
                                <input class="mb-3" type="text" style="border: none; width: 890px" value="{{$Data->about ?? ''}}">
                                <form action="{{url('updateAboutAfterLogin/'.$Data->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('patch')
        ...
        <div class="accordion-item">
            ...
            <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                <a href="{{route('category.workAfterLogin')}}" class="btn btn-secondary bg-gradient my-5 mx-4">Add Work</a>
            </div>
        </div>
        {{-- MY WORK END HERE --}}
        ...
        <div class="accordion-item">
            ...
            <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                <a href="{{route('category.educationAfterLogin')}}" class="btn btn-secondary bg-gradient my-5 mx-4">Add Education</a>
            </div>
        </div>
        {{-- EDUCATION END HERE --}}
        ...
        <div class="accordion-item">
            ...
            <div id="flush-collapseFive" class="accordion-collapse collapse" aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
                <a href="{{route('category.skillsAfterLogin')}}" class="btn btn-secondary bg-gradient my-5 mx-4">Add Skills</a>
            </div>
        </div>
        {{-- SKILL END HERE --}}
        ...
        <div class="accordion-item">
            ...
            <div id="flush-collapseSix" class="accordion-collapse collapse" aria-labelledby="flush-headingSix" data-bs-parent="#accordionFlushExample">
                <a href="{{route('category.experianceAfterLogin')}}" class="btn btn-secondary bg-gradient my-5 mx-4">Add Experiance</a>
            </div>
        </div>
        {{-- EXPERIANCE END HERE --}}
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseSeven" class="accordion-collapse collapse" aria-labelledby="flush-headingSeven" data-bs-parent="#accordionFlushExample">
                            <div class="mx-4 my-5" style="width: 420px;">
                                {{--  @dd($personalData)  --}}
                                <form action="{{url('updatePersonalAfterLogin/'.$Data->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('patch')

                                    <div class="mb-3">
                                        <label for="father_name" class="form-label">Father Name</label>
                                        <input type="text" name="father_name" id="father_name" value="{{$Data->father_name}}" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label for="mother_name" class="form-label">Mother Name</label>
                                        <input type="text" name="mother_name" id="mother_name" value="{{$Data->mother_name}}" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label for="permanent_address" class="form-label">Permanent Address</label>
                                        <input type="text" name="permanent_address" id="permanent_address" value="{{$Data->permanent_address}}" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label for="height" class="form-label">Height</label>
                                        <input type="text" name="height" id="height" value="{{$Data->height}}" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <strong>Sex: </strong>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="blood_group" id="blood_group" value="{{$Data->blood_group}}" class="form-control mb-3" required>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="religion" id="religion" value="{{$Data->religion}}" class="form-control mb-3" required>
                                    </div>
                                    <div>
                                        <label for="nid_number" class="form-label mb-3">NID Number</label>
                                        <input type="number" name="nid_number" id="nid_number" value="{{$Data->nid_number}}" class="form-control mb-3" required>
                                    </div>
                                    <div>
                                        <label for="nationality" class="form-label mb-3">Nationality</label>
                                        <input type="text" name="nationality" id="nationality" value="{{$Data->nationality}}" class="form-control mb-3" required>
                                    </div>
                                    {{--  preview accordian statr here  --}}
                                    <div class="row mb-5">
                                        <label for="signature" class="form-label mb-3">Add Signature</label>
                                        <div class="col-md-6">
                                            <input type="file" name="signature" id="imgInp3" value="{{$Data->signature}}" class="form-control mb-3" required>
                                        </div>
                                        <div class="col-md-6">
                ...
                @if($authorizedUser->id == $Data->id)
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseEight" class="accordion-collapse collapse" aria-labelledby="flush-headingSeven" data-bs-parent="#accordionFlushExample">
                            <div class="mx-4 my-5" style="width: 420px;">
                                <form action="{{url('updateSocialMediaAfterLogin/'.$Data->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('patch')

                                    <div class="mb-3">
                                        <label for="skype" class="form-label">Skype</label>
                                        <input type="text" name="skype" id="skype" value="{{$Data->skype}}" class="form-control">
                                    </div>
                                    <div class="mb-3">
